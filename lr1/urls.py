...
urlpatterns = [
    ...
    path(r'plane_configuration_elements/<int:pk>/', views.ConfigurationElement.as_view(), name='configuration_element'),
    path(r'plane_configuration_elements/<int:pk>/put/', views.put, name='configuration_element_put'),
