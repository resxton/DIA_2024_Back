...
urlpatterns = [
    ...
    path(r'plane_configuration_elements/', views.ConfigurationElements.as_view(), name='configuration_elements'),
	path(r'plane_configuration_element/add/', views.add_new_element, name='add_new_configuration_element'),
    path(r'plane_configuration_element/<int:pk>/', views.ConfigurationElement.as_view(), name='configuration_element'),
    path(r'plane_configuration_element/<int:pk>/edit/', views.put, name='configuration_element_put'),	path(r'users/', views.UsersList.as_view(), name='users-list'),
