...
class Configuration(models.Model):
    ...
    created_at = models.DateTimeField(default=timezone.now)  # Убрали default
    updated_at = models.DateTimeField(auto_now=True)  # Дата последнего обновления (дата формирования)
    ...
    class Meta:
        db_table = 'configurations'  # Название таблицы
